...
@section('content')
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('dokter.appointments') }}" class="btn btn-outline-secondary">
        ...
        <form action="{{ route('dokter.medical-records.store') }}" method="POST" onsubmit="return validateForm()">
            @csrf
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('dokter.appointments') }}" class="btn btn-secondary">
