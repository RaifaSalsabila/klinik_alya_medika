    ...
    <style>
        * {
        ...
        .hero-section {
            ...
            overflow: hidden;
            padding-top: 80px; /* Memberikan ruang di atas untuk header */
        ...
        .hero-section .hero-image img {
            object-fit: cover;  /* Menjaga gambar tetap terpotong proporsional */
            width: 100%;
            height: 100%;
            max-height: 500px;  /* Atur sesuai dengan tinggi yang diinginkan */
            border-radius: 20px;
        ...
        .hero-content {
            ...
            gap: 3rem; /* Mengatur jarak antara teks dan gambar */
            align-items: center;
            padding: 2rem; /* Menambahkan ruang di dalam hero section */
        }
        .hero-text {
            z-index: 3;
        }
            ...
            <div class="schedule-grid">
                ...
                <div class="doctor-card">
                    ...
                    <div class="schedule-note">
                        <p><i class="fas fa-info-circle me-1"></i>Melayani konsultasi untuk masalah kesehatan sehari-hari, mulai dari penyakit ringan hingga pengelolaan kondisi kronis.</p>
                    </div>
                </div>
                ...
                <div class="doctor-card">
                    ...
                    <div class="schedule-note">
                        <p><i class="fas fa-info-circle me-1"></i> Konsultasi kehamilan, USG, dan kesehatan reproduksi wanita</p>
                    </div>
                </div>
                ...
                <div class="doctor-card">
                    ...
                    <div class="schedule-note">
                        <p><i class="fas fa-info-circle me-1"></i>Konsultasi kesehatan gigi dan mulut, perawatan pencegahan, dan penanganan masalah gigi seperti karies atau gigi berlubang.</p>
                    </div>
                </div>
            </div>
            
            <div class="text-center mt-5">
                <div class="alert alert-info d-inline-block" style="background: linear-gradient(135deg, #dbeafe, #bfdbfe); border: none; border-radius: 15px; padding: 1.5rem 2rem;">
                    <h5 class="mb-2"><i class="fas fa-calendar-alt me-2"></i>Informasi Penting</h5>
                    <p class="mb-0">Jadwal dapat berubah sewaktu-waktu. Silakan hubungi klinik untuk konfirmasi atau daftar appointment online untuk memastikan slot tersedia.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="about-content">
                <div class="about-text">
                    ...
                    <p>
                        Klinik Alya Medika adalah klinik kesehatan yang didirikan dengan semangat untuk memberikan perawatan kesehatan yang berkualitas, dengan perhatian penuh pada kenyamanan dan kebutuhan pasien.
                    </p>
                    <p>
                        Kami menyediakan layanan medis dengan dokter yang berpengalaman dan fasilitas yang memadai untuk melayani Anda dan keluarga dalam menjaga kesehatan.
                    </p>
                </div>
